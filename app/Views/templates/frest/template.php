                                ...
                                <li class="scrollable-container media-list"><a class="d-flex justify-content-between" href="javascript:void(0)">
                                        <div class="media d-flex align-items-center">
                                            <div class="media-left pr-0">
                                                <div class="avatar mr-1 m-0"><img src="<?php echo base_url('app-assets/images/portrait/small/avatar-s-11.jpg'); ?>" alt="avatar" height="39" width="39"></div>
                                            </div>
                                    ...
                                    <div class="d-flex justify-content-between read-notification cursor-pointer">
                                        <div class="media d-flex align-items-center">
                                            <div class="media-left pr-0">
                                                <div class="avatar mr-1 m-0"><img src="<?php echo base_url('app-assets/images/portrait/small/avatar-s-16.jpg'); ?>" alt="avatar" height="39" width="39"></div>
                                            </div>
                                            <div class="media-body">
                                    ...
                                    <div class="d-flex justify-content-between cursor-pointer">
                                        <div class="media d-flex align-items-center py-0">
                                            <div class="media-left pr-0"><img class="mr-1" src="<?php echo base_url('app-assets/images/icon/sketch-mac-icon.png'); ?>" alt="avatar" height="39" width="39"></div>
                                            <div class="media-body">
                                    ...
                                    <div class="d-flex justify-content-between read-notification cursor-pointer">
                                        <div class="media d-flex align-items-center">
                                            <div class="media-left pr-0">
                                                <div class="avatar mr-1 m-0"><img src="<?php echo base_url('app-assets/images/portrait/small/avatar-s-4.jpg'); ?>" alt="avatar" height="39" width="39"></div>
                                            </div>
                                            <div class="media-body">
    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="<?php echo base_url('html/ltr/vertical-menu-template-semi-dark/index.html'); ?>">
                        <div class="brand-logo"><img class="logo" src="<?php echo base_url('app-assets/images/logo/logo.png'); ?>" /></div>
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="lines">
                <li class=" nav-item"><a href="<?php echo base_url('html/ltr/vertical-menu-template-semi-dark/index.html'); ?>"><i class="menu-livicon" data-icon="desktop"></i><span class="menu-title" data-i18n="Dashboard">Dashboard</span><span class="badge badge-light-danger badge-pill badge-round float-right mr-2">2</span></a>
                ...
                <li class=" nav-item"><a href="#"><i class="menu-livicon" data-icon="unlink"></i><span class="menu-title" data-i18n="Starter kit">Starter kit</span></a>
                    <ul class="menu-content">
                        <li><a href="<?php echo base_url('starter-kit/ltr/vertical-menu-template-semi-dark/sk-layout-1-column.html'); ?>"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="1 column">1 column</span></a>
                        </li>
                        <li><a href="<?php echo base_url('starter-kit/ltr/vertical-menu-template-semi-dark/sk-layout-2-columns.html'); ?>"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="2 columns">2 columns</span></a>
                        </li>
                        <li><a href="<?php echo base_url('starter-kit/ltr/vertical-menu-template-semi-dark/sk-layout-fixed-navbar.html'); ?>"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Fixed navbar">Fixed navbar</span></a>
                        </li>
                        <li><a href="<?php echo base_url('starter-kit/ltr/vertical-menu-template-semi-dark/sk-layout-floating-navbar.html'); ?>"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Floating navbar">Floating navbar</span></a>
                        </li>
                        <li><a href="<?php echo base_url('starter-kit/ltr/vertical-menu-template-semi-dark/sk-layout-fixed.html'); ?>"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Fixed layout">Fixed layout</span></a>
                        </li>
                        <li><a href="<?php echo base_url('starter-kit/ltr/vertical-menu-template-semi-dark/sk-layout-static.html'); ?>"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Static layout">Static layout</span></a>
                        </li>
                    </ul>
                </li>
                    ...
                    <div class="media m-75">
                        <a href="JavaScript:void(0);">
                            <div class="avatar mr-75">
                                <img src="<?php echo base_url('app-assets/images/portrait/small/avatar-s-2.jpg'); ?>" alt="avtar images" width="32" height="32">
